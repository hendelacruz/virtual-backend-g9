...
# variable1, variable2, variable3 = ["eduardo", "martin", "jose luis"]
# #cuando no se tiene la misma cantidad de variables como en la lista arroja error
...
print(f"Los multiplos de 3 son {multiplos_3}, multiplos de 5 son {multiplos_5}")
