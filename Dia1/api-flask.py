...
productos = [
    {"nombre": "Palta fuerte", "precio": 5.20},
    {"nombre": "Albahca 100gr.", "precio": 0.80},
]
...
def inicio():
    ...
    return {"message": "Bienvenido a mi API", "content": ""}
...
def gestion_productos():
    ...
    if request.method == "GET":
        return {"message": None, "content": productos}
        ...
        return {"message": "Producto Creado exitosamente", "content": producto}, 201
...
def gestion_producto(id):
    ...
    if id < total_productos:
        if request.method == "GET":
            return {"content": productos[id], "message": None}, 200
            ...
            return {"content": None, "message": "Producto eliminado exitosamente"}
